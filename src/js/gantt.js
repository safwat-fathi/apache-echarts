...
var now1_2 = new Date().setDate(now.getDate() + 22);
...
var _taskData2 = [
  {
    ...
    ower: "",
    image:
      "http://carismartes.com.br/assets/global/images/avatars/avatar2_big@2x.png",
  },
  {
    groupName: "Group 3",
    groupOrder: 3,
    ...
    ower: "",
    image:
      "http://carismartes.com.br/assets/global/images/avatars/avatar1_big@2x.png",
  },
  {
    groupName: "Group 2",
    groupOrder: 2,
    ...
    ower: "",
    image:
      "http://carismartes.com.br/assets/global/images/avatars/avatar3_big@2x.png",
  },
  {
    groupName: "Group 3",
    groupOrder: 3,
  ...
  },
  {
    ...
    ower: "",
    image:
      "http://carismartes.com.br/assets/global/images/avatars/avatar4_big@2x.png",
  },
  {
    groupName: "Group 2",
    groupOrder: 2,
    ...
    formatter: function (info) {
      ...
      return [
        '<div class="tooltip-title">' +
          echarts.format.encodeHTML(taskName) +
          "</div>",
        start + " - ",
        end + "<br>",
        donePercentage + "% done",
  ...
  series: [
    {
      id: "zebra",
      type: "custom",
      renderItem: renderZebra,
      dimensions: _zebraDataDimensions,
      encode: {
        x: -1, //[1, 2],
        y: 3, //reference of taskid
      },
      data: _zebraData, //Im changing the item object to array... this is why the encode is filled with indexed
    },
    {
      type: "custom",
      clip: true,
...
function renderGanttItem(params, api) {
  ...
  var text =
    barLength > taskNameWidth + 40 && x + barLength >= 180 ? taskName : "";
    ...
    children: [
      {
        ...
        shape: {
          x: 0,
          y: params.coordSys.y - 2 * barHeight + barHeight / 6,
          width: 210,
          height: 46,
        },
        style: {
...
function renderToday(params, api) {
  ...
  let todayText = echarts.time.format(new Date(), DATE_FORMAT, false);
...
function mapData(taskData) {
  ...
  var _groupData = mapGroups(taskData);
...
function mapGroups(taskData) {
  ...
  for (let i = 0; i < taskData.length; i++) {
    if (mappedGroups[taskData[i].groupName] == undefined) {
      ...
      mappedGroups[taskData[i].groupName].color = getRandomHexColor();
...
var chartHeight = _mappedData.length * 80;
var myChart = echarts.init(document.getElementById("gantt"), undefined, {
...
myChart.on("click", function (params) {
  alert(
    "you clicked at " +
      ...
      " and we will change percentage to 100%"
  );
